  ...
  return (
    <div className={`${textColor} ${bg} shadow-lg shadow-white-500/50 rounded-sm mt-3 ml-3 text-center max-xl:mr-3`}>
      ...
      <div className='w-auto flex flex-wrap justify-center p-3 font-semibold'>
        ...
        <span className='text-xs bg-indigo-500 rounded-lg text-white m-1 px-2 max-xl:text-4xl'>JQery</span>
        ...
        <span className='text-xs bg-indigo-500 rounded-lg text-white m-1 px-2 max-xl:text-4xl'>C#</span>
        <span className='text-xs bg-indigo-500 rounded-lg text-white m-1 px-2 max-xl:text-4xl'>.NET</span>
        <span className='text-xs bg-indigo-500 rounded-lg text-white m-1 px-2 max-xl:text-4xl'>PHP</span>
        ...
        <span className='text-xs bg-indigo-500 rounded-lg text-white m-1 px-2 max-xl:text-4xl'>Node.js</span>
